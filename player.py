...
class Player(pygame.sprite.Sprite):
    """
    Represents the main character in the game which the player controls.
    """
    ...
    def __init__(self):
        ...
        image = pygame.transform.scale(pygame.image.load("player_run/run1.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run2.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run3.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run4.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run5.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run6.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run7.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
        image = pygame.transform.scale(pygame.image.load("player_run/run8.png").convert_alpha(), [width, height])
        self.running_frames_r.append(image)
